function [E_Y, SSD, PopQs] = DEBIPMNotShrink_Tuatara(E_Ymin,E_Ymax,step,MatrixSize)
...
Lmin = 8.4; % cm used to define limits of matrix approximation
Lb = 10.50; % disc width at birth in cm 
Lp = 45; % disc width at puberty in cm
Lm = 80; % maximum disc width in cm 
kappa = 0.79; % fraction energy allocation to respiration (as opposed to reproduction)
mu_juv = 0.27; % juvenile mortality rate (per year)
mu_ad = 0.05; % adult mortality rate (per year)
rb = 0.05; % von Bertalanffy growth rate (per year)
Rm = 4.50; % maximum number of offspring produced per year at L_m
