function [E_Y, SSD, PopQs] = DEBIPMNotShrink_GrassSnake(E_Ymin,E_Ymax,step,MatrixSize)
...
Lmin = 15.2; % cm used to define limits of matrix approximation
Lb = 19; % disc width at birth in cm 
Lp = 68; % disc width at puberty in cm
Lm = 190; % maximum disc width in cm 
kappa = 0.59; % fraction energy allocation to respiration (as opposed to reproduction)
mu_juv = 0.42; % juvenile mortality rate (per year)
mu_ad = 0.40; % adult mortality rate (per year)
rb = 0.11; % von Bertalanffy growth rate (per year)
Rm = 40; % maximum number of offspring produced per year at L_m
