function [E_Y, SSD, PopQs] = DEBIPMNotShrink_SoftShellClam(E_Ymin,E_Ymax,step,MatrixSize)
...
Lmin = 0.64; % cm used to define limits of matrix approximation
Lb = 0.8; % disc width at birth in cm 
Lp = 4; % disc width at puberty in cm
Lm = 15; % maximum disc width in cm 
kappa = 0.75; % fraction energy allocation to respiration (as opposed to reproduction)
mu_juv = 0.34; % juvenile mortality rate (per year)
mu_ad = 0.08; % adult mortality rate (per year)
rb = 0.73; % von Bertalanffy growth rate (per year)
Rm = 2000000.00; % maximum number of offspring produced per year at L_m
