...
name1=0.6530   # PC1 axis: fill this in for your pca output: summary(pca)! fraction variance explained by first axis; this output should be copied from summary(pca) 
name2=0.2552   # PC2 axis: fill this in for your pca output: summary(pca)! fraction variance explained by second axis;this output should be copied from summary(pca)
...
write.csv(cbind(x$scores,PopQs$Species),"PCAscoresHIGHnodeb.csv",row.names=F)
